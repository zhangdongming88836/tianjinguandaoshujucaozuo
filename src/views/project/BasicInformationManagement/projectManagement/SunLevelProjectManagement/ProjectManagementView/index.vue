...
<script>
import { projectInformationList,projectInformationcompany,projectInformationworkArea,projectInformationproject,projectInformationremove,projectInformationdetails } from '@/api/PM'
export default {
  ...
  methods: {
    ...
    //打开钩子
    open() {
       projectInformationdetails(this.ruleForm.id).then(res=>{
         console.log(res)
